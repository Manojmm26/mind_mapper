...
export type StudioTab = "rosetta" | "teleprompter" | "sql" | "decision";
  ...
  return (
    <div className="min-h-screen bg-[radial-gradient(circle_at_top_left,rgba(125,211,252,0.18),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(253,186,116,0.2),transparent_25%),linear-gradient(180deg,#f8fafc_0%,#f1f5f9_100%)] dark:bg-[radial-gradient(circle_at_top_left,rgba(14,165,233,0.1),transparent_32%),radial-gradient(circle_at_bottom_right,rgba(249,115,22,0.1),transparent_25%),linear-gradient(180deg,#0b0f19_0%,#060913_100%)] p-4 sm:p-6 lg:p-8">
      <div className="mx-auto max-w-7xl space-y-6">
        {/* Top Navigation Bar */}
        <header className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 rounded-3xl border border-white/80 dark:border-white/10 bg-white/75 dark:bg-slate-900/80 p-4 sm:p-5 shadow-[0_12px_40px_rgba(15,23,42,0.06)] backdrop-blur-xl">
          ...
          <div className="flex flex-wrap items-center gap-1.5 rounded-2xl bg-slate-100 dark:bg-slate-800/80 p-1.5 border border-slate-200/60 dark:border-slate-700/60">
            <button
            ...
            >
              ...
              <span>The Rosetta Stone (22)</span>
            </button>
        ...
        <main className="transition-all duration-300">
          ...
          {activeTab === "teleprompter" && <ScenarioTeleprompter />}
