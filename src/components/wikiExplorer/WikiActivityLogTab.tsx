    ...
    <div className="space-y-3">
      {isLoading ? (
        ...
        logs.map((log) => (
          <div
            key={log.id}
            className="group flex items-start gap-3 rounded-[20px] border border-slate-200/80 bg-gradient-to-br from-slate-50 to-white p-4 shadow-sm transition-all hover:border-cyan-200 hover:shadow-md"
          >
            <div
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center justify-between gap-2">
                <span className="text-sm font-black tracking-tight text-slate-950 capitalize">
                  {log.type}
                </span>
