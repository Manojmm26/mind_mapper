      ...
      {isLoading ? (
        ...
        <>
          ...
          <div className="rounded-[28px] bg-white p-5 shadow-sm ring-1 ring-slate-100">
            <div className="inline-flex items-center gap-2 rounded-full bg-slate-100/80 px-2.5 py-0.5 text-[9px] font-black uppercase tracking-[0.2em] text-slate-500 mb-3">
              ...
              {Object.entries(stats.sourceTypeBreakdown).map(
                ([type, count]) => (
                  ...
                  >
                    ...
                    <span className="inline-flex h-7 w-7 items-center justify-center rounded-full bg-cyan-50 text-xs font-black text-cyan-700">
                      {count}
                    </span>
                  </div>
                ),
