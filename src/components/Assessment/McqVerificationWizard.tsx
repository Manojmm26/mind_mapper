    ...
    <div className="mx-auto max-w-3xl space-y-6">
      ...
      <div className="rounded-[28px] border border-white/70 bg-white/80 p-6 shadow-sm backdrop-blur-xl">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div>
            <div className="inline-flex items-center gap-1.5 rounded-full bg-amber-50 px-3 py-1 text-[11px] font-black uppercase tracking-widest text-amber-700">
              <ShieldCheck size={12} />
                ...
                <button
                  ...
                  className={`group flex w-full items-start gap-4 rounded-2xl border p-4 text-left transition-all ${
                    selected
                      ...
                      : "border-slate-200 bg-slate-50/50 text-slate-700 hover:border-amber-300 hover:bg-white"
                  }`}
                >
                  <div
                    className={`flex h-7 w-7 shrink-0 items-center justify-center rounded-full text-xs font-black transition-colors ${
                      selected
                        ...
                        : "bg-slate-200 text-slate-600 group-hover:bg-amber-200 group-hover:text-amber-800"
                    }`}
                  >
